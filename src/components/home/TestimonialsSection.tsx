...
const testimonials = [
  ...
  },
  {
    id: 2,
    quote:
      "My electricians stay on the tools. The front desk books the jobs into Trade and only calls us when it's technical.",
    name: "James Walker",
  ...
  },
  {
    id: 3,
    quote:
      "Mechanics under the hood, not on the phone. Workshop plus a real receptionist filtered the chaos out of our workshop.",
    name: "Emily Chen",
